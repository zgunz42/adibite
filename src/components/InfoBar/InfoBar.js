...
class InfoBar extends React.Component {
  constructor(props, context) {
    ...
    this.homeLinkOnClick = featureNavigator.bind(this);
    this.pageLinkOnClick = moveNavigatorAside.bind(this);
  }
...
export default connect(mapStateToProps, mapDispatchToProps)(withStyles(styles)(InfoBar));
